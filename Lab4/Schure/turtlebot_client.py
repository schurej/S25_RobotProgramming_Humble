...
class TurtleClient(Node):
    def __init__(self):
        ...
        self.declare_parameter('turtleColor' , 'red' , ParameterDescriptor(description = 'Turtle Color'))
        self.declare_parameter('penWide' , 3 , ParameterDescriptor(description = "Pen Width"))
        ...
        penWide = self.get_parameter('penWide').get_parameter_value().integer_value
        self.turtle_display.pensize(penWide)
